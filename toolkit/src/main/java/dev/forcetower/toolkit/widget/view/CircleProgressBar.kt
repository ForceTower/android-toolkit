...
package dev.forcetower.toolkit.widget.view
...
class CircleProgressBar(ctx: Context, private val attrs: AttributeSet) : View(ctx, attrs) {
    ...
    private fun init() {
        ...
        try {
            ...
            alphaTint = typedArray.getFloat(R.styleable.CircleProgressBar_backgroundAlpha, alphaTint)
        ...
        backgroundPaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
            color = adjustAlpha(this@CircleProgressBar.color, alphaTint)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val angle = (360 * progress / max) * direction
